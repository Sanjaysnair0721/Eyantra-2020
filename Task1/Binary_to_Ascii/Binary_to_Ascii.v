...
always@*
	begin
		if (conversion_complete_int != 0)				// Monitor if BCD conversion of integer part is done or not, if done then prceed with ascii conversion
		begin
		/* 
...
/////////////////// The Below always block is same as above. This block is for the decimal part //////////////////////
	always @*
	begin
		if (conversion_complete_dec != 0)				// Monitor if BCD conversion of decimal part is done or not, if done then prceed with ascii conversion.
		begin
		/* 
